...
class TXNSampleVar:
    ...
    def calc_vars_summary_repay_stat(self, day_list=[None, 1, ]):
        ...
        def __calc(df, day):
            ...
            varname_cnt = "_".join(["bank_txn_lender_repay_amount_count", "l"+str(day)+"d"]) if bool(day) else "bank_txn_lender_repay_amount_count"
    ...
    def calc_vars_summary_disburse_stat(self, day_list=[None, 1, ]):
        ...
        def __calc(df, day):
            ...
            varname_cnt = "_".join(["bank_txn_lender_disburse_amount_count", "l"+str(day)+"d"]) if bool(day) else "bank_txn_lender_disburse_amount_count"
